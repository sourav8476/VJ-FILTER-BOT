...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002216660895'))
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002150640075')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '7504571407')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002216660895')).split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/backupmoviezone')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_download_moviezone/5')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviezonesuppot') # Support Chat Link Without https:// or @
