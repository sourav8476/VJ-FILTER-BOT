...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "refer":
        ...
        refer = await referal_add_user(user_id, message.from_user.id)
        if refer and PREMIUM_AND_REFERAL_MODE == True:
